...
do	
    if [[ -f $file ]]; then
		...
		eval swagger-codegen generate -i ../docs/event-detection-api.yaml -l $fname -c $file -o $folder/$fname 
    fi
done
